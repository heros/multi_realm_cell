...
enum AuraType
{
    ...
    SPELL_AURA_PERIODIC_MANA_FUNNEL                         = 63,   // old SPELL_AURA_PERIODIC_MANA_FUNNEL
    ...
    PELL_AURA_SHARE_PET_TRACKING                            = 119,  // old SPELL_AURA_SHARE_PET_TRACKING
    ...
    SPELL_AURA_MOD_RANGED_AMMO_HASTE                        = 141,  // old SPELL_AURA_MOD_RANGED_AMMO_HASTE, unused now
    ...
    SPELL_AURA_SPLIT_DAMAGE_FLA                             = 153,  // old SPELL_AURA_SPLIT_DAMAGE_FLAT. unused 4.3.4
    ...
    SPELL_AURA_MOD_AOE_AVOIDANCE                            = 160,  // old SPELL_AURA_MOD_AOE_AVOIDANCE. Unused 4.3.4
    ...
    SPELL_AURA_MOD_CRIT_PERCENT_VERSUS                      = 169,  // old SPELL_AURA_MOD_CRIT_PERCENT_VERSUS. unused 4.3.4
    SPELL_AURA_DETECT_AMORE                                 = 170,
    SPELL_AURA_MOD_SPEED_NOT_STACK                          = 171,
    SPELL_AURA_MOD_MOUNTED_SPEED_NOT_STACK                  = 172,
    SPELL_AURA_ALLOW_CHAMPION_SPELLS                        = 173,  // old SPELL_AURA_ALLOW_CHAMPION_SPELLS
    ...
    SPELL_AURA_MOD_DEBUFF_RESISTANCE                        = 178,  // old SPELL_AURA_MOD_DEBUFF_RESISTANCE, unused
    SPELL_AURA_MOD_ATTACKER_SPELL_CRIT_CHANCE               = 179,
    SPELL_AURA_MOD_FLAT_SPELL_DAMAGE_VERSUS                 = 180,
    SPELL_AURA_MOD_FLAT_SPELL_CRIT_DAMAGE_VERSUS            = 181,  // old SPELL_AURA_MOD_FLAT_SPELL_CRIT_DAMAGE_VERSUS - possible flat spell crit damage versus
    ...
    SPELL_AURA_MOD_ALL_WEAPON_SKILLS                        = 198,  // old SPELL_AURA_MOD_ALL_WEAPON_SKILLS
    SPELL_AURA_MOD_INCREASES_SPELL_PCT_TO_HIT               = 199,  // old SPELL_AURA_MOD_INCREASES_SPELL_PCT_TO_HIT. unused 4.3.4
    ...
    SPELL_AURA_258                                          = 258,
    SPELL_AURA_MOD_HOT_PCT                                  = 259,  // old SPELL_AURA_MOD_HOT_PCT, unused 4.3.4
    ...
    SSPELL_AURA_MOD_ABILITY_IGNORE_TARGET_RESIST            = 270,  // old SPELL_AURA_MOD_ABILITY_IGNORE_TARGET_RESIST, unused 4.3.4
    ...
    SPELL_AURA_MOD_MAX_AFFECTED_TARGETS                     = 277,  // old SPELL_AURA_MOD_MAX_AFFECTED_TARGETS. unused 4.3.4
